...
# Dream Homes NYC ETL loader.
# Notes:
# - Update the PostgreSQL connection string before running.
# - The canonical final schema for the repo is in sql/schema/dreamhomes_postgres_schema.sql.
# - This script keeps the original project loading logic and load order.
...
# SQL schema used during loading.
# Keep the standalone schema file in sql/schema/ as the source of truth.
schema = """
...
# ETL: load all CSV files from the curated repo data folder.
