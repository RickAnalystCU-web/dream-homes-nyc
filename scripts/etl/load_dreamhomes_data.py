"""Create the Dream Homes NYC tables and load the synthetic CSV dataset."""
...
# Replace only the placeholder values; never commit a real database password.
CONNECTION_URL = 'postgresql://postgres:your_password@localhost:5432/your_database_name'
